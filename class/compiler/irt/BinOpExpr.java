// Archivo: compiler/irt/BinOpExpr.java
package compiler.irt;

/**
 * Clase que representa una expresión de operación binaria en el IRT.
 */
public class BinOpExpr extends IRExp {
     ...
     */
    public BinOpExpr(String operator, IRExp left, IRExp right) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BinOpExpr)) return false;
        BinOpExpr other = (BinOpExpr) obj;
    ...
    /**
     * Retorna una representación en cadena de la expresión de operación binaria.
     *
